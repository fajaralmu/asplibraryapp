                ...
                if (Attributes.Length > 0)
                {
                    ...
                    if (Attribute.FieldType != null)
                    {
                        ...
                        switch (Attribute.FieldType)
                        {
                            ...
                            case AttributeConstant.TYPE_ID_AI:
                            ...
                            case AttributeConstant.TYPE_TEXTAREA:
                                ...
                                FieldCell.Controls.Add(FieldControl);
                                break;
                            case AttributeConstant.TYPE_READONLY:
                                FieldControl = new Label();
                                FieldControl.ID = PropsInfo.Name;
                                //  ((Label)FieldControl).CssClass = "form-control";
                                FieldCell.Controls.Add(FieldControl);
                                break;
            ...
            for (int i = 0; i < Props.Length; i++)
            {
                ...
                if (Attributes.Length > 0)
                {
                    ...
                    if (Attribute.FieldType != null)
                    {
                        ...
                        Label LabelHeader = ControlUtil.GenerateLabel(StringUtil.ToUpperCase(0, FieldName.ToLower()) + "<br/>");
                        TextBox FilterBox = new TextBox();
                        FilterBox.ID = "_LABEL_SEARCH_" + PropsInfo.Name;
                ...
                if (Attributes.Length > 0)
                {
                    ...
                    if (Attribute.FieldType != null)
                    {
                        ...
                        if (Attribute.AutoGenerated)
                        {
                            ...
                            else if (Attribute.FieldType.Equals(AttributeConstant.TYPE_ID_AI))
                            {
                                InputValue = null;
                            }
                            else
                ...
                if (Attributes.Length > 0)
                {
                    ...
                    if (Attribute.FieldType != null)
                    {
                        ...
                        else
                        {
                            ...
                            else if (Attribute.FieldType.Equals(AttributeConstant.TYPE_READONLY))
                            {
                                Label InputControl = (Label)TableForm.FindControl(PropsInfo.Name);
                                object PropValue = ObjectUtil.GetValueFromProp(PropsInfo.Name, Object);
                                if (PropValue != null)
                                    InputControl.Text = PropValue.ToString().TrimEnd();
                            }
            ...
            for (int i = 0; i < Props.Length; i++)
            {
                ...
                if (Attributes.Length > 0)
                {
                    ...
                    if (Attribute.FieldType != null)
                    {
                        ...
                        {
                            if (!Attribute.FieldType.Equals(AttributeConstant.TYPE_DROPDOWN)
                                && !Attribute.FieldType.Equals(AttributeConstant.TYPE_FILE_IMAGE)
                                && !Attribute.FieldType.Equals(AttributeConstant.TYPE_READONLY))
